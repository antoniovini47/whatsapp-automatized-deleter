...
def deleteLeads(amount):
    ...
    for lead in range(amount):
        ...
        pyautogui.click(firstClickPosition[0]-65, firstClickPosition[1]-40, duration=secondClickDuration)
        pyautogui.click(firstClickPosition[0]-410, firstClickPosition[1]-55, duration=secondClickDuration)
